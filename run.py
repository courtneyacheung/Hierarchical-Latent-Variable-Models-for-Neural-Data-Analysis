...
spikes, clusters_good, spikes_g, events, trials, contrast, choice, accuracy = region_search('SCdg', insertions_7, 33)
...
#plot_trajectories2L is a function from the last year capstone group (Aryan Singh, Jad Makki, Saket Arora, Rishabh Viswanathan).
...
plot_trajectories2L(z_test, choice[:num_train], accuracy[:num_train], 0.05 *1000, region_name = region_name, is_train = False)
